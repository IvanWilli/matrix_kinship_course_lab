...
![Caswell, 2021. Fig 2.](time_var_boundaries.png){width=80%}
...
**1.1** Using the `data` object created above but for your own country, reshape the survival data in the same way in which we reshaped the fertility data above. You can plot the qx values over age for all periods available in the same way we did for Sweden (use different colours for each period).
