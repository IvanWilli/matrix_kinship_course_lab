...
```
**E1.2** Compare 'kin sex ratios' of grandparents, parents, daughters and siblings in a time-variant framework for the cohort 1950, at each of Focal.
...
For this exercise, you should use `DemoKin` to replicate this figure. Concretely, run three iterations of the kinship model:
   ...
   1. One-sex model; time-invariant rates; no two-sex approximation
...
`Model ID` = 1:3
  ...
  , `Two-sex approximation` = c("None", "Androgynous fertility", "None")
) %>%
  knitr::kable()
```
