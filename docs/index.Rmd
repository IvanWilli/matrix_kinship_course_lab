...
- Syllabus: sent by mail but can be found also in https://github.com/IvanWilli/matrix_kinship_course_lab/syllabus.
...
- Data for exercises can be found in previous dropbox folder or at https://github.com/IvanWilli/matrix_kinship_course_lab/data.
...
# with vectors:
# dim(a_vector) gives error. Vectors in R are dimensionless, don´t have a dimension by default but have a length. Operationally it works as a column vector.
length(a_vector)
```
